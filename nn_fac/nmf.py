...
def one_nmf_step_test(data, rank, U_in, V_in, norm_data, update_rule, beta,
                 sparsity_coefficients, fixed_modes, normalize, deterministic, rev_order=False, n_stepU=100, n_stepV=100):
    """
